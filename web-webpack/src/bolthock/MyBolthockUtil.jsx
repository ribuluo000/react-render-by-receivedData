  ...
  "actionSheet":[                                 // 交互操作界面 
     { 
      ...
      { 
          ...
          { 
          "widgetName" :"datepicker",                 // 控件类型:text、textarea、select、datepicker、timepicker、citypicker、phone...
          "title" :"日期",                         // 显示的标题
          "subTitle" :"请选择",                    // 显示的副标题，非必须
          "valueKey" : "date",                  // 字段名称 
          "value":"",
    ...
    { 
          "widgetName" :"timepicker",                 // 控件类型:text、textarea、select、datepicker、timepicker、citypicker、phone...
          "title" :"时间",                         // 显示的标题
          "subTitle" :"请选择",                    // 显示的副标题，非必须
          "valueKey" : "time",                  // 字段名称 
          "value":"",
    ...
    { 
          "widgetName" :"citypicker",                 // 控件类型:text、textarea、select、datepicker、timepicker、citypicker、phone...
          "title" :"选择地区",                         // 显示的标题
          "subTitle" :"请选择",                    // 显示的副标题，非必须
          "valueKey" : "city",                  // 字段名称 
          "value":"",
